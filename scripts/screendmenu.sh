...
case $OPT in
	A_clip ) maim -s | xclip -selection clipboard -i -t image/png && notify-send -i ~/logo/screen.png "Screenshot taken" ;;
    ...
    Full_clip ) maim -g 1920x1080  | xclip -selection clipboard -i -t image/png && notify-send -i ~/logo/screen.png "Screenshot taken" ;;   
