...
alias nn='nnn -ed'
alias n='nnn -ed'
export NNN_PLUG='p:mocq;i:imgview;c:fzcd;t:mp3conv;e:suedit;v:preview-tui;V:nuke;x:!doas chmod +x $nnn;s:!bash -i*;d:xdgdefault' #to play this plug press ; then choose option 
